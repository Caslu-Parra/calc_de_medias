...
class MediaPonderada extends StatefulWidget {
  @override
  _MediaPonderadaState createState() => _MediaPonderadaState();
}

class _MediaPonderadaState extends State<MediaPonderada> {
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: TextField(
                        keyboardType: TextInputType.number,
                        decoration: InputDecoration(labelText: 'Peso 1'),
                        onChanged: (value) {
                          print(value);
                          setState(() {
                            _controller.setPeso(double.parse(value) ?? 0.00, 1);
                          });
                        },
                      ),
                    ),
                    ...
                    Expanded(
                      ...
                      child: TextField(
                        keyboardType: TextInputType.number,
                        decoration: InputDecoration(labelText: 'Peso 2'),
                        onChanged: (value) {
                          print(value);
                          setState(() {
                            _controller.setPeso(double.parse(value) ?? 0.00, 2);
                          });
                        },
                      ),
                    ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: TextField(
                        keyboardType: TextInputType.number,
                        decoration: InputDecoration(labelText: 'Peso 3'),
                        onChanged: (value) {
                          print(value);
                          setState(() {
                            _controller.setPeso(double.parse(value) ?? 0.00, 3);
                          });
                        },
                      ),
                    ),
                    ...
                    Expanded(
                      ...
                      child: TextField(
                        keyboardType: TextInputType.number,
                        decoration: InputDecoration(labelText: 'Peso 4'),
                        onChanged: (value) {
                          print(value);
                          setState(() {
                            _controller.setPeso(double.parse(value) ?? 0.00, 4);
                          });
                        },
                      ),
                    ),
